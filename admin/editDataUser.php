        ...
        <form method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama"
              value="<?php echo $row['nama_depan']; echo " "; echo $row['nama_belakang'] ?>" class="form-control">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="date" name="tanggalLahir" value="<?= $row['tanggal_lahir'] ?>" class="form-control">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="noTelp" value="<?= $row['no_telp'] ?>" class="form-control">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="passwordConfirmation" value="<?= $row['password_confirmation'] ?>"
              class="form-control">
          </div>
          <input type="hidden" name="nin" value="<?= $nin ?>">
          <button type="submit" class="btn btn-primary" name="editDataUser">Simpan</button>
          <?php } ?>
        </form>
      </div>
    </section>
